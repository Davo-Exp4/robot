...
# Funcion utilizada para los actuadores (nivel de agua y relays)
def actuadores():
    """
    ...
    while True:
        ...
        test = print(mqtt.check_msg())
        # if(mqtt.check_msg != "None"):
        #    Flag.clear_run_flag() 
        # print(test)
        mqtt.check_msg()
        # Prueba led
...
second_thread = _thread.start_new_thread(actuadores, ())                      
execution_core()